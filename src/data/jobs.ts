...
export const jobs: Job[] = [
    {
        ...
        images: [`${BASE_URL}/jobs/Vodafone_dithered.png`, `${BASE_URL}/jobs/Vodafone2_dithered.png`],
        layout: 'text-right',
    },
    {
        ...
        images: [`${BASE_URL}/jobs/Directors_dithered.png`, `${BASE_URL}/jobs/Directors2_dithered.png`, `${BASE_URL}/jobs/Directors3_dithered.png`],
    ...
    },
    {
        ...
        images: [`${BASE_URL}/jobs/BlaBlaCar_dithered.png`],
        layout: 'text-right',
    },
    {
        ...
        images: [`${BASE_URL}/jobs/BadPlace3_dithered.png`, `${BASE_URL}/jobs/BadPlace2_dithered.png`, `${BASE_URL}/jobs/BadPlace_dithered.png`],
        layout: 'images-bottom',
    }
];
...
export const jobs: Job[] = [
    {
        ...
        images: ['/my-page2.0/jobs/Vodafone_dithered.png', '/my-page2.0/jobs/Vodafone2_dithered.png'],
        layout: 'text-right',
    },
    {
        ...
        images: ['/my-page2.0/jobs/Directors_dithered.png', '/my-page2.0/jobs/Directors2_dithered.png', '/my-page2.0/jobs/Directors3_dithered.png'],
    ...
    },
    {
        ...
        images: ['/my-page2.0/jobs/BlaBlaCar_dithered.png'],
        layout: 'text-right',
    },
    {
        ...
        images: ['/my-page2.0/jobs/BadPlace3_dithered.png', '/my-page2.0/jobs/BadPlace2_dithered.png', '/my-page2.0/jobs/BadPlace_dithered.png'],
        layout: 'images-bottom',
    }
];